...
nvinfer1::ILayer* convBnSiLU(nvinfer1::INetworkDefinition* network,
    ...
    // relu
    // nvinfer1::ILayer* relu = network->addActivation(*bn->getOutput(0), nvinfer1::ActivationType::kRELU);
    // return relu;
}
...
nvinfer1::ILayer* bottleneck(nvinfer1::INetworkDefinition* network, std::map<std::string, nvinfer1::Weights> weightMap,
    ...
    nvinfer1::ILayer* conv1 = convBnSiLU(network, weightMap, input, c2, 3, 1, 1, lname + ".cv1");
...
nvinfer1::ILayer* C2F(nvinfer1::INetworkDefinition* network,
    ...
    nvinfer1::ILayer* conv1 = convBnSiLU(network, weightMap, input, 2 * c_, 1, 1, 0, lname + ".cv1");
...
nvinfer1::ILayer* C3(nvinfer1::INetworkDefinition* network,
                                ...
                                int c2, int n, bool shortcut, float e, std::string lname) {
    int c_ = (float)c2 * e;
    nvinfer1::ILayer* cv1 = convBnSiLU(network, weightMap, input, c_, 1, 1, calculateP(1), lname + ".cv1");
    nvinfer1::ILayer* cv2 = convBnSiLU(network, weightMap, input, c_, 1, 1, calculateP(1), lname + ".cv2");
...
nvinfer1::ILayer* SPPF(nvinfer1::INetworkDefinition* network,
    ...
    int c_ = c1 / 2;
    nvinfer1::ILayer* conv1 = convBnSiLU(network, weightMap, input, c_, 1, 1, 0, lname + ".cv1");
